      ...
      <div className="flex w-full relative flex-col items-center justify-between h-[600px] md:h-[750px]">
        <div className="flex flex-col items-center justify-center gap-2 mt-16 text-center md:gap-8 text-light-p">
          ...
          <p
            ...
            data-aos-delay="500"
            data-aos-offset="0"
            className="md:text-1xl font-Accent font-thin tracking-[10px] translate-x-1 md:tracking-[30px] dark:text-dark-p"
          >
            FRONT END
          </p>
          <h1
          ...
          <p
            ...
            data-aos-delay="3900"
            data-aos-offset="0"
            className="px-3 md:font-semibold text-1xl font-Accent md:text-6xl text-light-p dark:text-dark-p"
          >
