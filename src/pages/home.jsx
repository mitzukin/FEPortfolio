...
const Home = () => {
  return (
    <div className="flex items-center justify-center h-screen transition-all duration-500 ease-in-out font-primary bg-background-light dark:bg-background-dark">
      <div className="flex relative flex-col items-center justify-between h-[500px]">
        <div className="flex flex-col items-center justify-center gap-2 text-center md:gap-6 text-light-p">
          ...
          <p className="lg:text-3xl font-light translate-x-4 tracking-[25px] dark:text-dark-p">
            FRONT END
          </p>
          <h1 className="text-3xl font-bold z-2 Designer dark:text-teal font-secondary text-DarkBlue">
            & UI DESIGNER
          </h1>
          <p className="px-3 font-light dark:text-dark-p">
